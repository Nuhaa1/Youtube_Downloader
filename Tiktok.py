...
def send_welcome(message):
    bot.reply_to(message, "This bot was created by @BigDaddyAman for experimental purposes. Send me a YouTube, Dailymotion, or TikTok link, and I'll download the video for you!")
